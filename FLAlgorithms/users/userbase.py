...
import numpy as np
import copy
from FLAlgorithms.utils import get_dataset_name
from FLAlgorithms.utils.model_config import RUNCONFIGS
...
class User:
    ...
    """
    def __init__(
            self, args, id, model, dataset, use_adam=False):
        ...
        self.train_teacher_epochs = RUNCONFIGS[dataset_name]['train_teacher_epochs']
    ...
    def test(self):
        ...
        return test_acc, loss, self.datas.test_numbers
